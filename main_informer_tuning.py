...
# Define search space
search_space = {'learning_rate': tune.loguniform(1e-4, 1e-2), 'train_epochs': tune.randint(10)}
...
parser.add_argument('--root_path', type=str, default='./data/SRL/', help='root path of the data file')
